        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    ...
                    <span class="m-r-sm text-muted welcome-message" style="font-family:Noto Sans Lao, sans-serif;"><b>ຍິນດີຕອນຮັບເຂົ້າສູ່ຫນ້າໂປຣຟາຍຂອງທ່ານ</b> </span>
                </li>
                <li class="dropdown">
			        ...
			        <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                              <h5><span class="label label-primary pull-right fs-2" style="font-family:Noto Sans Lao, sans-serif;">ລະຫັດເຂົ້າສູ່ DASHBOARD ຂອງທ່ານ</span>
</h5>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                              <h5><span class="label label-info pull-right" style="font-family:Noto Sans Lao, sans-serif;">ວັນທີ່ສະມັກເຂົ້າ</span>
</h5>
                            </div>
                            <div class="ibox-content">
...
{ ?>
 <h4 style="color:red" style="font-family:Noto Sans Lao, sans-serif;">ມ.ສ ໂນນສະອາດ, ຍັງບໍ່ທັນຊຳລະຄ່າຮຽນ.</h4>
			   <?php } else {?>
	 <h4 style="color:green" style="font-family:Noto Sans Lao, sans-serif;"> ຍິນດີຕອນຮັບນ້ອງ, ຊຳລະຄາຮຽນສຳແລວແລ້ວ </h4>
