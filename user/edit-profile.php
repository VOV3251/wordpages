...
$sql1 = " update admission set photo='$location' where email='$email'";
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
				...
				<span class="m-r-sm text-muted welcome-message fs-3"> ຍິນດີເຂົ້າສູ່ DASHBOARD.</span>
...
$row= mysqli_fetch_array($result);
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-6 b-r"><h2 class="m-t-none m-b"><b>ເພີ່ມຫນ້າປົກຂອງຕົວເອງ</b></h2>
                                ...
                                <p class="text-center">
                                  <input name="userImage" type="file" class="inputFile" />
                                    ...
                                    <div>
                                        ...
                                        <div align="centre"><strong><i class="fa fa-paste btn-lg fs-3"></i><h3>ເພີ່ມຫນ້າປົກ</h3> </strong></div>
                                        </button>
                                  </div>
                                </form>
                            </div>
