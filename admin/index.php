...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link fs-3">Home</a>  </li>
  ...
  <a href="#" class="brand-link">
      <img src="../images/log.jpg" alt=" Logo" width="167" height="149" style="opacity: .8">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <p><strong style="font-family:Noto Sans Lao, sans-serif;">No. ນັກຮຽນທັງຫມົດທີ່ສະຫມັກເຂົ້າ </strong></p>
              </div>
              <div class="icon">
                <i class=""></i>
              </div>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                <p><strong style="font-family:Noto Sans Lao, sans-serif;">No. ນັກຮຽນທີ່ ຍືນຍັນສຳເລັດ</strong></p>
              </div>
              <div class="icon">
                <i class=""></i>
              </div>
