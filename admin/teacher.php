...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO teacher (name, gender, address, gmail, phone) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $name, $gender, $address, $gmail, $phone);
    if ($stmt->execute()) {
        $feedback = '<div class="alert alert-success" role="alert">New teacher added successfully!</div>';
    } else {
        $feedback = '<div class="alert alert-danger" role="alert">Error: ' . $conn->error . '</div>';
    }
}
